export const resumeData = {
    personalInfo: {
        ...
        links: {
            linkedin: "#", // Add actual link
            medium: "#",   // Add actual link
            devCommunity: "#", // Add actual link
    ...
    projects: [
        {
            ...
            description: "Created a basic real-time messaging web app using Node.js and Express to practice WebSocket with the Socket.IO library. Implemented real-time messaging functionality.",
            technologies: ["HTML", "CSS", "JavaScript", "Node.js", "Express"],
            link: "#" // GitHub Repository
        },
        {
            title: "Confidential Client Projects (under NDA)",
            description: "Delivered multiple React.js applications for enterprise clients, focusing on reusable components, responsive design, and performance optimization. Implemented state management with Redux Toolkit and Context API. Integrated UI frameworks such as Tailwind CSS, Shadcn, Ant Design, and Material UI.",
            technologies: ["React.js", "Redux Toolkit", "Context API", "Tailwind CSS", "Shadcn", "Ant Design", "Material UI"],
            link: null
        }
    ],
    publications: [
